...
"You see the skeleton of a dwarf.", True, None, 2, "You use the axe to smash open the chest.",lockedchest, brokenchest, "You see a BROKEN CHEST.", False)
...
player = Player(player_name, nextroom, [], [axe,bread])
